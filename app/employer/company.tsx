...
import { CompanyDetails } from '@/stores/jobStore';
    ...
    try {
      ...
      if (companyId) {
        ...
        if (logoImage) {
          ...
          const logoUrl = await useJobStore.getState().uploadImageToStorage(logoImage, logoPath);
          if (logoUrl) {
        ...
        if (coverImage) {
          ...
          const coverUrl = await useJobStore.getState().uploadImageToStorage(coverImage, coverPath);
          if (coverUrl) {
        ...
        Alert.alert('Error', 'Failed to create company profile. Please try again.');
      }
    } catch (error: any) {
  ...
  const renderCompanyItem = ({ item }: { item: CompanyDetails }) => (
    <View style={styles.companyCard}>
      ...
      <View style={styles.companyContactInfo}>
        ...
        {item.contact_phone && (
          <Text style={styles.contactItem}>
            <Feather name="phone" size={14} color="#6b7280" /> {item.contact_phone}
          </Text>
        )}
        {item.website && (
          <Text style={styles.contactItem}>
          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.formContainer}>
              ...
              <View style={styles.imagePickerContainer}>
                {logoImage ? (
                  ...
                  >
                    ...
                    <Text style={styles.imagePickerText}>Select Logo Image</Text>
                  </TouchableOpacity>
                )}
              </View>
              ...
              <TextInput
                ...
                placeholderTextColor="#9ca3af"
              />
              <Text style={styles.inputHelp}>Direct image selection is preferred over URL</Text>
