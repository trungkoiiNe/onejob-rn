...
export default function EmployerDashboard() {
  ...
  const RecentActivity = ({ title, subtitle, time, type }: any) => (
            ...
            >
              ...
              <View style={styles.performanceStats}>
                <View style={styles.performanceStat}>
                  ...
                  <Text style={styles.performanceStatLabel}>Application Rate</Text>
                </View>
                <View style={styles.performanceStat}>
                  <Text style={styles.performanceStatValue}>89%</Text>
                  <Text style={styles.performanceStatLabel}>Interview Rate</Text>
                </View>
                <View style={styles.performanceStat}>
