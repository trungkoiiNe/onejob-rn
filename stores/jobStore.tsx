...
export type JobSalaryType = 'per_hour' | 'per_shift' | 'per_day' | 'fixed' | 'negotiable';
export type JobType = 'part_time' | 'full_time' | 'internship' | 'freelance' | 'urgent';
...
interface JobState {
    ...
    updateCompany: (id: string, companyDetails: Partial<CompanyDetails>) => Promise<boolean>;
    deleteCompany: (id: string) => Promise<boolean>;
    selectCompany: (company: CompanyDetails) => void;
    clearSelectedCompany: () => void;

    // Image upload method
    uploadImageToStorage: (filePath: string, storagePath: string) => Promise<string | null>;
}
...
export const useJobStore = create<JobState>((set, get) => ({
    ...
    updateCompany: async (id: string, companyDetails: Partial<CompanyDetails>) => {
        try {
            set({ isLoading: true, error: null });

            // Convert companyDetails keys to snake_case for the database
            const dbCompanyDetails: any = {};
    ...
    uploadImageToStorage: async (filePath: string, storagePath: string): Promise<string | null> => {
        try {
            set({ isLoading: true, error: null });
